...
- [ ] **Paginación en Listados:** Implementar `.paginate()` en las vistas de contenedores y usuarios.
...
- [ ] **Rate Limiting (Flask-Limiter):** Protección contra fuerza bruta en login y reset de contraseña.
...
- [ ] **Sistema de Etiquetas (Tags):** Categorizar contenedores para búsquedas avanzadas.
